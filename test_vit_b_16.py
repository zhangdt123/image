...
class TestConfig:
    ...
    model_path = "model_epoch1_vit_b_16.pth"
    result_csv = "run_vit_b_16.csv"
    similarity_threshold = 0.63
    input_size = 224
    batch_size = 256


from contrastive_vit_b_16 import AdvancedContrastiveModel
...
class FeatureExtractor(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, x):
        x = self.encoder[0](x)  # [batch_size, seq_length, hidden_dim]
        features = self.encoder[1](x[:, 0])[0]  # [batch_size, hidden_dim]

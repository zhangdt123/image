...
class TestConfig:
    ...
    model_path = "F:/image clef2025/moe_model_best3.pth"
    result_csv = "run3.csv"
...
def main():
    ...
    def batch_extract(dataset):
        ...
        for batch, names in loader:
            batch = batch.to(TestConfig.device)
            with torch.no_grad():

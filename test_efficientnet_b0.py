...
class TestConfig:
    ...
    model_path = "model_epoch_effi1.pth"  # 对应 EfficientNet-B0 训练检查点
    result_csv = "run_efficientnet_b0.csv"
...
# 从训练文件导入模型定义
from contrastive_efficientnet_b0 import AdvancedContrastiveModel
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return self.transform(img), self.filenames[idx]  # 直接返回 tensor
